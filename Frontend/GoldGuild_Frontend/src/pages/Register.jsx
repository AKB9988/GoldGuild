            ...
            <div className="w-full max-w-md bg-[#1A1A1A] rounded-[24px] border border-[#333]/60 p-8 shadow-2xl transition-all duration-300 hover:border-[#F59E0B]/30 flex flex-col justify-between min-h-[500px]">
                <div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="block text-[#9CA3AF] text-[11px] mb-1 font-medium">Username</label>
                            <input 
                                type="text" 
                        ...
                        >
                            {signup.isPending ? "Registering...." : "Sign Up"}
                        </button>
                    </form>
                </div>

                <div className="text-center mt-8 text-[#9CA3AF] text-xs">
                    Already have an account? <span className="text-[#F59E0B] hover:underline ml-1 font-medium">Login</span>
                </div>
            </div>
        </div>
    )
